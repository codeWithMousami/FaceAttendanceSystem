...
file = open('EncodeFilee.p','rb')
encoencodeListKnowWithIds = pickle.load(file)
file.close()
encodeListKnown,studentIds= encoencodeListKnowWithIds
#print(studentIds)
...
while True:
    ...
    # Flip the webcam image horizontally
    img = cv2.flip(img, 1)

    imgS = cv2.resize(img,(0,0),None,0.25,0.25)
    imgS = cv2.cvtColor(imgS,cv2.COLOR_BGR2RGB)  # Convert grayscale to RGB
